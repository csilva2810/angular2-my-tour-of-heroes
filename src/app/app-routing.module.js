System.register(['@angular/core', '@angular/router', './dashboard/dashboard.component', './hero/heroes.component', './hero/hero-detail.component'], function(exports_1, context_1) {
    "use strict";
